...
//
//	mockgen --build_flags=--mod=mod --destination=./storage/mock_storage/storage.go github.com/sejamuchhal/taskhub/auth/storage StorageInterface
//
...
func (m *MockStorageInterface) BlockSessionByID(arg0 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockSessionByID", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// BlockSessionByID indicates an expected call of BlockSessionByID.
func (mr *MockStorageInterfaceMockRecorder) BlockSessionByID(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockSessionByID", reflect.TypeOf((*MockStorageInterface)(nil).BlockSessionByID), arg0)
}

// CreateSession mocks base method.
func (m *MockStorageInterface) CreateSession(arg0 *storage.Session) error {
	m.ctrl.T.Helper()
...
func (mr *MockStorageInterfaceMockRecorder) CreateSession(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSession", reflect.TypeOf((*MockStorageInterface)(nil).CreateSession), arg0)
}
...
func (m *MockStorageInterface) DeleteSessionByID(arg0 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteSessionByID", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteSessionByID indicates an expected call of DeleteSessionByID.
func (mr *MockStorageInterfaceMockRecorder) DeleteSessionByID(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteSessionByID", reflect.TypeOf((*MockStorageInterface)(nil).DeleteSessionByID), arg0)
}
